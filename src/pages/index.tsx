          ...
          <li className="border-l-2 border-gray-300">
            <div className="flex flex-start">
              ...
              <div className="h-[100px] px-2 md:px-4 text-md text-gray-600">
                ...
                <br />
                <div className="text-xs mt-2 ">Jun 2024 - Present</div>
              </div>
            </div>
          </li>
          <li className="border-l-2 border-gray-300">
            <div className="flex flex-start">
              ...
              <div className="h-[100px] px-2 md:px-4 text-md text-gray-600">
                ...
                <br />
                <div className="text-xs mt-2 ">Jul 2023 - Jun 2024</div>
              </div>
            </div>
          </li>
          <li className="border-l-2 border-gray-300">
            <div className="flex flex-start">
              ...
              <div className="h-[100px] px-2 md:px-4 text-md text-gray-600">
                ...
                <br />
                <div className="text-xs mt-2 ">Jun 2022 - Jul 2023</div>
              </div>
            </div>
          </li>
          <li className="border-l-2 border-gray-300">
            <div className="flex flex-start">
              ...
              <div className="h-[100px] px-2 md:px-4 text-md text-gray-600">
                ...
                <br />
                <div className="text-xs mt-2 ">Jun 2021 - Aug 2021</div>
              </div>
            </div>
          </li>
        </ol>
